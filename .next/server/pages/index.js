...
async function getStaticProps() {
    //fetch data from API
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://iditked:18787kedmy@cluster0.fgcfldw.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
